                ...
                <div className="relative z-10 flex items-center justify-center h-full px-6">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
                            SHUT UP & <span className="text-yellow-400">RAVE</span>
                        </h1>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                            <button className="bg-yellow-400 text-black font-semibold py-3 px-8 rounded-full duration-300 cursor-pointer hover:scale-105 active:scale-95 md:w-full w-[55%]">
                                Get Tickets Now
                            </button>
                            <button className="border-2 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black font-semibold py-3 px-8 rounded-full duration-300 cursor-pointer hover:scale-105 active:scale-95 md:w-full w-[55%]">
                                Learn More
                            </button>
                        </div>
